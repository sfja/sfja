...
[]
*)
(** subject reduction 性が成り立つのなら、その逆の性質、 subject expansion 性も成り立つかどうか考えるのが合理的でしょう。すなわち、 [t ==> t'] かつ [has_type t' T] ならば [has_type t T] は常に成り立つでしょうか。そうだと思うのなら、証明しなさい。そうでないと思うのなら、反例を挙げなさい。
